...
export const LEGALINFO_PARSER_ID = "legalinfo-html-v1";
...
const CHAPTER_HEAD_RE =
  /^(?:(АРВАН|ХОРИН|ГУЧИН|ДӨЧИН|ТАВИН)\s+)?(НЭГДҮГЭЭР|ХОЁРДУГААР|ГУРАВДУГААР|ДӨРӨВДҮГЭЭР|ТАВДУГААР|ЗУРГАДУГААР|ЗУРГААДУГААР|ДОЛООДУГААР|ДОЛДУГААР|НАЙМДУГААР|ЕСДҮГЭЭР|АРАВДУГААР|ХОРЬДУГААР|ГУЧДУГААР|ДӨЧДҮГЭЭР)(?:\^(\d+))?\s+БҮЛЭГ(?:\^(\d+))?(?:[.\s:—-]*(.*))?$/i;
